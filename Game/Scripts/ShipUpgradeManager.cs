...
public class ShipUpgradeManager : MonoBehaviour
{
    ...
    private void UpdateUI()
    {
        ...
        else
        {
            ...
            _healthPriceText.text = "Price: " + _shipModel.GetHealthPrice().ToString();
            _attackPriceText.text = "Price: " + _shipModel.GetAttackPrice().ToString();
            _attackSpeedPriceText.text = "Price: " + _shipModel.GetAttackSpeedPrice().ToString();
        }
    ...
    public void BuyUpHealth()
    {
        ...
        else
        {
            DOTween.To(() => oldPrice, x =>
            {
                _healthPriceText.text = "Price: " + x.ToString("F0");
            }, newPrice, 0.5f);
        }
    ...
    public void BuyUpAttack()
    {
        ...
        else
        {
            DOTween.To(() => oldPrice, x =>
            {
                _attackPriceText.text = "Price: " + x.ToString("F0");
            }, newPrice, 0.5f);
        }
    ...
    public void BuyUpAttackSpeed()
    {
        ...
        if (YG2.lang == "ru")
        {
            ...
            {
                _attackSpeedText.text = x.ToString("F1") + "/с";
        ...
        else
        {
            DOTween.To(() => oldPrice, x =>
            {
                _attackSpeedPriceText.text = "Price: " + x.ToString("F0");
            }, newPrice, 0.5f);
            DOTween.To(() => oldAttackSpeed, x =>
            {
