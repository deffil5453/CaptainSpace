...
public class SpaceShipSpawnScript : MonoBehaviour
{
    ...
    private void Spawn()
    {
        ...
        _gameObjectSpaceShip.GetComponent<ShipHealthSystem>().Inizialize(_inventory.CurrentShip.BaseHealth);
        _gameObjectSpaceShip.GetComponent<ShipAttack>().Inizialize(_inventory.CurrentShip.BaseAttack, _inventory.CurrentShip.BaseAttackSpeed);
